...
namespace Microsoft.FeatureManagement
{
    ...
    /// }
    /// 
    /// With custom merging (default behavior):
    ...
    public class ConfigurationFeatureDefinitionProviderOptions
    {
        ...
        /// </summary>
        /// <remarks>
        /// This option only affects Microsoft schema feature flags (e.g. feature_management:feature_flags arrays). 
        /// .NET schema feature flags are not affected by this setting.
        /// </remarks>
        public bool DisableCustomConfigurationMerging { get; set; } = true;
    }
}
