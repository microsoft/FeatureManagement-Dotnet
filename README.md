...
``` C#
//
// An implementation of `ITargetingContextAccessor` is needed to 
services.AddSingleton<ITargetingContextAccessor, HttpContextTargetingContextAccessor>();
